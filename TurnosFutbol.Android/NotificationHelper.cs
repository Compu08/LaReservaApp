    ...
    class NotificationHelper : INotification
    {
        ...
        public void CreateNotification(String title, String message)
        {
            try
            {
                ...
                var sound = global::Android.Net.Uri.Parse(ContentResolver.SchemeAndroidResource + "://" + mContext.PackageName);
                ...
                mBuilder.SetSmallIcon(Resource.Drawable.logo_notif);
