        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch (parameter.ToString())
            {
                ...
                case "4" when (bool)value:
                    ...
                    return (Color)retVal;
                case "4":
                    Application.Current.Resources.TryGetValue("Gray-600", out object outVal);
                    return (Color)outVal;
                case "5" when (bool)value:
                    Application.Current.Resources.TryGetValue("Green", out object retGreen);
                    return (Color)retGreen;
                case "5":
                    Application.Current.Resources.TryGetValue("Red", out object retRed);
                    return (Color)retRed;
                case "6" when (bool)value:
                    Application.Current.Resources.TryGetValue("Gray-300", out object gray300);
                    return (Color)gray300;
                case "6":
                    Application.Current.Resources.TryGetValue("Secondary", out object secondary);
                    return (Color)secondary;
                case "7" when !(bool)value:
                    Application.Current.Resources.TryGetValue("Gray-100", out object gray100);
                    return (Color)gray100;
                case "8" when (bool)value:
                    Application.Current.Resources.TryGetValue("PrimaryColor", out object primary);
                    return (Color)primary;
                case "8":
                    Application.Current.Resources.TryGetValue("Gray-White", out object graywhite);
