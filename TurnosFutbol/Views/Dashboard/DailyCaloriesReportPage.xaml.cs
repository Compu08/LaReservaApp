...
namespace TurnosFutbol.Views.Dashboard
{
    /// <summary>
    ...
    public partial class DailyCaloriesReportPage
    {
        ...
        {
            ObservableCollection<Pointer> ranges = new ObservableCollection<Pointer>();
            double rangeStart = 0;

            ObservableCollection<Calorie> items = SfListView.ItemsSource as ObservableCollection<Calorie>;
            RangePointer proteinRange = new RangePointer();
        ...
        private void SessionButton_OnClicked(object sender, EventArgs e)
        {
            ...
            CaloriesCard context = (sender as SfButton).BindingContext as CaloriesCard;
