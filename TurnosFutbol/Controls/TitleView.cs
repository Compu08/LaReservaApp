...
namespace TurnosFutbol.Controls
{
    ...
    public class TitleView : Grid
    {
        ...
        public static readonly BindableProperty TextColor = BindableProperty.Create(nameof(ColorText), typeof(Color), typeof(TitleView), Color.Black, BindingMode.Default);
        ...
        public TitleView()
        {
            ...
            BoxView boxView = new BoxView { Color = (Color)Application.Current.Resources["DivisionLines"] };
        ...
        {
            get { return (Color)GetValue(TextColor); }
            set { this.SetValue(TextColor, value); }
        }
        ...
        private static void OnTitlePropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            if (!string.IsNullOrEmpty(newText))
            {
                ...
                {
                    Text = newText,
                    TextColor = (Color)Application.Current.Resources["TitleTextColor"],
                    FontSize = 16,
